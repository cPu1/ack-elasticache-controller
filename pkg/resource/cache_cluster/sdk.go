	...
	for _, elem := range resp.CacheClusters {
		...
		if elem.PendingModifiedValues != nil {
			...
			if elem.PendingModifiedValues.LogDeliveryConfigurations != nil {
				f22f4 := []*svcapitypes.PendingLogDeliveryConfiguration{}
				for _, f22f4iter := range elem.PendingModifiedValues.LogDeliveryConfigurations {
					f22f4elem := &svcapitypes.PendingLogDeliveryConfiguration{}
					if f22f4iter.DestinationDetails != nil {
						f22f4elemf0 := &svcapitypes.DestinationDetails{}
						if f22f4iter.DestinationDetails.CloudWatchLogsDetails != nil {
							f22f4elemf0f0 := &svcapitypes.CloudWatchLogsDestinationDetails{}
							if f22f4iter.DestinationDetails.CloudWatchLogsDetails.LogGroup != nil {
								f22f4elemf0f0.LogGroup = f22f4iter.DestinationDetails.CloudWatchLogsDetails.LogGroup
							}
							f22f4elemf0.CloudWatchLogsDetails = f22f4elemf0f0
						}
						if f22f4iter.DestinationDetails.KinesisFirehoseDetails != nil {
							f22f4elemf0f1 := &svcapitypes.KinesisFirehoseDestinationDetails{}
							if f22f4iter.DestinationDetails.KinesisFirehoseDetails.DeliveryStream != nil {
								f22f4elemf0f1.DeliveryStream = f22f4iter.DestinationDetails.KinesisFirehoseDetails.DeliveryStream
							}
							f22f4elemf0.KinesisFirehoseDetails = f22f4elemf0f1
						}
						f22f4elem.DestinationDetails = f22f4elemf0
					}
					if f22f4iter.DestinationType != nil {
						f22f4elem.DestinationType = f22f4iter.DestinationType
					}
					if f22f4iter.LogFormat != nil {
						f22f4elem.LogFormat = f22f4iter.LogFormat
					}
					if f22f4iter.LogType != nil {
						f22f4elem.LogType = f22f4iter.LogType
					}
					f22f4 = append(f22f4, f22f4elem)
				}
				f22.LogDeliveryConfigurations = f22f4
			}
...
func (rm *resourceManager) sdkCreate(
	...
	if resp.CacheCluster.PendingModifiedValues != nil {
		...
		if resp.CacheCluster.PendingModifiedValues.LogDeliveryConfigurations != nil {
			f22f4 := []*svcapitypes.PendingLogDeliveryConfiguration{}
			for _, f22f4iter := range resp.CacheCluster.PendingModifiedValues.LogDeliveryConfigurations {
				f22f4elem := &svcapitypes.PendingLogDeliveryConfiguration{}
				if f22f4iter.DestinationDetails != nil {
					f22f4elemf0 := &svcapitypes.DestinationDetails{}
					if f22f4iter.DestinationDetails.CloudWatchLogsDetails != nil {
