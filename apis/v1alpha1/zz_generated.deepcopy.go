...
func (in *CacheClusterStatus) DeepCopyInto(out *CacheClusterStatus) {
	*out = *in
	...
	if in.CacheParameterGroup != nil {
		in, out := &in.CacheParameterGroup, &out.CacheParameterGroup
		*out = new(CacheParameterGroupStatus_SDK)
		(*in).DeepCopyInto(*out)
	}
	if in.CacheSecurityGroups != nil {
		in, out := &in.CacheSecurityGroups, &out.CacheSecurityGroups
		*out = make([]*CacheSecurityGroupMembership, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PendingLogDeliveryConfiguration) DeepCopyInto(out *PendingLogDeliveryConfiguration) {
	*out = *in
	if in.DestinationDetails != nil {
		in, out := &in.DestinationDetails, &out.DestinationDetails
		*out = new(DestinationDetails)
...
func (in *PendingLogDeliveryConfiguration) DeepCopy() *PendingLogDeliveryConfiguration {
	if in == nil {
		return nil
	}
	out := new(PendingLogDeliveryConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ReplicationGroupStatus) DeepCopyInto(out *ReplicationGroupStatus) {
	*out = *in
	...
	if in.MemberClustersOutpostARNs != nil {
		in, out := &in.MemberClustersOutpostARNs, &out.MemberClustersOutpostARNs
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *UserGroupPendingChanges) DeepCopyInto(out *UserGroupPendingChanges) {
	*out = *in
	if in.UserIDsToAdd != nil {
		in, out := &in.UserIDsToAdd, &out.UserIDsToAdd
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.UserIDsToRemove != nil {
		in, out := &in.UserIDsToRemove, &out.UserIDsToRemove
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *UserGroupPendingChanges) DeepCopy() *UserGroupPendingChanges {
	if in == nil {
		return nil
	}
...
func (in *UserGroupStatus) DeepCopyInto(out *UserGroupStatus) {
	*out = *in
	...
	if in.ReplicationGroups != nil {
		in, out := &in.ReplicationGroups, &out.ReplicationGroups
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.ServerlessCaches != nil {
		in, out := &in.ServerlessCaches, &out.ServerlessCaches
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *UserStatus) DeepCopyInto(out *UserStatus) {
	*out = *in
	...
	if in.ExpandedAccessString != nil {
		in, out := &in.ExpandedAccessString, &out.ExpandedAccessString
		*out = new(string)
		**out = **in
	}
	if in.LastRequestedAccessString != nil {
		in, out := &in.LastRequestedAccessString, &out.LastRequestedAccessString
		*out = new(string)
		**out = **in
	}
	if in.MinimumEngineVersion != nil {
